      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
        ...
        <section className="py-10">
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            {/* Email Directly */}
            <div className="bg-gradient-to-r from-[#012156]/5 to-[#5ABE71]/5 rounded-xl p-6 border border-gray-200 animate-on-scroll">
              ...
              <div className="mt-6 pt-5 border-t border-gray-200 flex flex-wrap gap-3">
                <a
                  ...
                  className="flex-1 min-w-[140px] bg-[#012156] hover:bg-[#012156]/80 text-white px-4 py-2.5 rounded-lg font-['Orbitron'] text-xs tracking-wider transition-all shadow-sm hover:shadow-md inline-flex items-center justify-center gap-2"
                >
                  <i className="fas fa-phone"></i> Call Now
                </a>
                <a
                  href="https://wa.me/254721722823"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 min-w-[140px] bg-[#5ABE71] hover:bg-[#5ABE71]/85 text-white px-4 py-2.5 rounded-lg font-['Orbitron'] text-xs tracking-wider transition-all shadow-sm hover:shadow-md inline-flex items-center justify-center gap-2"
                >
